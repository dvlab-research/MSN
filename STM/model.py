...
class Encoder_M(nn.Module):
    ...
    def forward(self, in_f, in_m, in_o):
        # print('shape', in_f.shape, in_m.shape, in_o.shape)
...
class STM(nn.Module):
    ...
    def segment(self, frame, keys, values, num_objects): 
        ...
        # assert 1<0, (ps.shape, logit.shape)
        if pad[2]+pad[3] > 0:
